/**
 * MD5 and HMAC-MD5 hashing implementation
 * Pure JavaScript implementation for browser compatibility
 * Based on the reference implementation from ts.tsx
 */
 ...
 * @returns HMAC-MD5 hash as hex string
 */
export function hmacMd5(key: string, msg: string): string {
